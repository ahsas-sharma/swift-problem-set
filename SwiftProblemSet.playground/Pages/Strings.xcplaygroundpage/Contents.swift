...
let word = "shampoo"
let containsHam = word.contains("ham")
print("\(word) contain the substring 'ham'? : \(containsHam)")

//: ### Exercise 6
//: Declare two strings and then use a single operator to concatenate them together to create a third string.
let string1 = "I'm the first string"
let string2 = " and me be the second one."
...
//desired output = "$5.67"
print("Jose has $\(567/100).\(567%100)")
